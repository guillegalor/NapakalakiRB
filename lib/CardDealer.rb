...
module NapakalakiGame
  ...
  class CardDealer
    ...
    def initMonsterCardDeck
      ...
      @unusedMonsters << Monster.new("Felpuggoth", 2, badConsequence, prize)

      #[24] -4 contra sectarios
      prize = Prize.new(4, 2);
      badConsequence = BadConsequence.newLevelNumberOfTreasures("Pierdes 2 niveles", 2, 0, 0)
      @unusedMonsters << Monster.new("Shoggoth", 16, badConsequence, prize)
